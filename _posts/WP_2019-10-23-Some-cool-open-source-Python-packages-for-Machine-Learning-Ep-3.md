...
EDIT: here is a very nice post that compares [Hyperopt](https://github.com/hyperopt/hyperopt) with [Optuna](https://github.com/optuna/optuna), mentioned in [EP 1](https://www.architecture-performance.fr/ap_blog/some-cool-open-source-python-packages-for-machine-learning-ep-1/) (2019/07/11): [https://neptune.ai/blog/optuna-vs-hyperopt](https://neptune.ai/blog/optuna-vs-hyperopt)
